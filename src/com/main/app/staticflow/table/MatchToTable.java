...
public class MatchToTable {
	...
	public static String[][] getMatchTableFormat(Match m) {
		...
		String[][] match = { { "Data Layer Destination", m.getDataLayerDestination() },
				{ "Data Layer Source", m.getDataLayerSource() }, { "Data Layer Type", m.getDataLayerType() },
				{ "Data Layer VLAN", m.getDataLayerVLAN() }, { "Data Layer PCP", m.getDataLayerPCP() },
				{ "Input Port", m.getInputPort() }, { "Network Destination", m.getNetworkDestination() },
				{ "Network Protocol", m.getNetworkProtocol() }, { "Network Source", m.getNetworkSource() },
				{ "Network Type Of Service", m.getNetworkTypeOfService() },
				{ "Transport Destination", m.getTransportDestination() },
				{ "Transport Source", m.getTransportSource() }, { "Tcp Destination", m.getTcpDestination() },
				{ "Tcp Source", m.getTcpSource() }, { "Udp Destination", m.getUdpDestination() },
	...
	public static String[][] getNewMatchTableFormat() {
		String[][] match = { { "Data Layer Destination", "" }, { "Data Layer Source", "" }, { "Data Layer Type", "" },
				{ "Data Layer VLAN", "" }, { "Data Layer PCP", "" }, { "Input Port", "" },
				{ "Network Destination", "" }, { "Network Protocol", "" }, { "Network Source", "" },
				{ "Network Type Of Service", "" }, { "Transport Destination", "" }, { "Transport Source", "" }
				// ,{ "Wildcards", "" }
		};
		return match;
	}
	...
	public static boolean errorChecksPassed(Switch sw, TableItem[] items) {
		 ...
		 * "Network Protocol must be a valid number."); return false; }
		 */
		...
		if (checkPorts) {
			...
			if (ports.containsKey(items[5].getText(1))) {
				return true;
			}
